#ifndef _InDrvC8051CoreH
#define _InDrvC8051CoreH

/****************************************************************************/
/***                    常量定义                                                */
/****************************************************************************/
#define FEED_IN_WDOG()          (WDTCN = 0xA5)
...
sfr DPL         = 0x82;     /*DATA POINTER - LOW BYET               */
sfr DPH         = 0x83;     /*DATA POINTER - HIGH BYET              */
sfr P4          = 0x84;     /*PORT 4                                */
sfr P5          = 0x85;     /*PORT 5                                */
sfr P6          = 0x86;     /*PORT 6                                */
sfr PCON        = 0x87;     /*POWER CONTROL                         */
sfr TCON        = 0x88;     /*TIMER CONTROL                         */
sfr TMON        = 0x89;     /*TIMER MODE                            */
...
sfr ADC0GTL     = 0xC4;     /*ADC 0 GREATER-THAN BEGISTER - LOW BYTE*/
...
sfr XBR0        = 0xE1;     /*DIGTAL CROSSBAR CONFIGURATION REGISTER 0*/
sfr XBR1        = 0xE2;     /*DIGTAL CROSSBAR CONFIGURATION REGISTER 1*/
sfr XBR2        = 0xE3;     /*DIGTAL CROSSBAR CONFIGURATION REGISTER 2*/
...
sbit RI0        = SCON0 ^ 0;    /*RECEIVE INTERRUPT FALG                */

/*      IE 0xA8             */
sbit EA         = IE ^ 7;       /*GLOBAL INTERRUPT ENABLE               */
sbit ET2        = IE ^ 5;       /*TIMER 2 INTERRUPT ENABLE              */
sbit ES0        = IE ^ 4;       /*UART 0 INTERRUPT ENABLE               */
...
sbit STO        = SMB0CN ^ 4;   /*SMBUS 0 STOP FALG                     */
sbit SI         = SMB0CN ^ 3;   /*SMBUS 0 INTERRUPT PENDING FLAG        */
sbit AA         = SMB0CN ^ 2;   /*SMBUS 0 ASSERT/ACKNOWLEDGE FALG       */
...
sbit EXF2       = T2CON ^ 6;    /*EXTERNAL ENABLE                       */
...
/*      PSW                 */
sbit CY         = PSW ^ 7;      /*CARRY FALG                            */
sbit AC         = PSW ^ 6;      /*AUXILIARY CARRY FALG                  */
sbit F0         = PSW ^ 5;      /*USER FLAG 0                           */
sbit RS1        = PSW ^ 4;      /*REGISTER BANK SELECT 1                */
sbit RS0        = PSW ^ 3;      /*REGISTER BANK SELECT 0                */
sbit OV         = PSW ^ 2;      /*OVERFLOW FALG                         */
...
sbit AD0INT     = ADC0CN ^ 5;   /*ADC 0 CONVERISION COMPLETE INTERRUPT FALG*/
sbit AD0BUSY    = ADC0CN ^ 4;   /*ADC 0 BUSY FALG                       */
sbit AD0CM1     = ADC0CN ^ 3;   /*ADC 0 START OF CONVERSION MODE BIT 1  */
sbit AD0CM0     = ADC0CN ^ 2;   /*ADC 0 START OF CONVERSION MODE BIT 0  */
sbit AD0WINT    = ADC0CN ^ 1;   /*ADC 0 WINDOW COMPARE INTERRUPT FALG   */
sbit AD0LJST    = ADC0CN ^ 0;   /*ADC 0 RIGHT JUSTFY DATA BIT           */
...
sbit TXBSY      = SPI0CN ^ 3;   /*SPI 0 TX BUSY FALG                    */
